...
INSERT INTO goods (GOODS_ID, ATOMS_GOODS_ID, ORIGIN_PRICE, SALE_PRICE, IMAGE_URL, CREATE_TIME, UPDATE_TIME, STATUS)
VALUES ('1', '1', 100, 99, 'http://www.baidu.com', NOW(), NOW(), 1);
INSERT INTO goods (GOODS_ID, ATOMS_GOODS_ID, ORIGIN_PRICE, SALE_PRICE, IMAGE_URL, CREATE_TIME, UPDATE_TIME, STATUS)
VALUES ('2', '1', 100, 98, 'http://www.baidu.com', NOW(), NOW(), 1);
